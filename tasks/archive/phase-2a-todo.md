...
- [x] **2.1 `PaymentMethod` 模型與 `Transaction` 欄位**
...
- [x] **3.1 `createLedgerForUser` 補付款方式種子**
...
- [x] **6.1 e2e：`resetDb` 調整 + 付款方式與交易情境**
